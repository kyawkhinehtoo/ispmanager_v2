                  ...
                  <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-4 gap-2">
                      ...
                      <div class="col-span-1 sm:col-span-1">
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm" v-if="pop_devices.length  !== 0">
                      ...
                      <div class="col-span-1 sm:col-span-1">
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm" v-if="res_dn?.length">
                      ...
                      <div class="col-span-1 sm:col-span-1">
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm" v-if="res_sn.length  !== 0">
